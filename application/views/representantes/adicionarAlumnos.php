    ...
    <span class="d-block p-2 bg-primary text-white">Adicionar Estudiante</span>
...
?>
  ...
  <!--<a href="" onclick="pass();">prueba</a>-->
    ...
    <div class="form-row">
     ...
     <label for="cedulaRepresentante">Cédula</label>
      <input type="text" class="form-control form-control-sm number" id="cedulaRepresentante" required="true" name="cedulaRepresentante"
       onblur="buscarConAjaxAdicionarAlum();" value="<?php echo set_value_input(array(), 'cedulaRepresentante', 'cedulaRepresentante') ?>">
    ...
    <div class="input-group-sm col-md-6">
      ...
      <input type="text" class="form-control form-control-sm" id="nombreRepresentante" readonly="true" name="nombreRepresentante" value="<?php echo set_value_input(array(), 'nombreRepresentante', 'nombreRepresentante') ?>">
    </div>
 ...
 <!-- -------------------------------------------------------------------------------------------->
            <div id="dymanic_field2">
                <div class="form-row" >
                  ...
                  <input type="text" class="form-control form-control-sm firstLetterText_frase letras" id="lugarNEstudiante" required="true" name="lugarNEstudiante[]" >
                  </div>
                  ...
                  <div class="form-group col-md-2">
                  <label for="cedulaEstudiante">Sexo</label>
                  ...
                  <input type="text" class="form-control form-control-sm firstLetterText letras" id="nombreMadre" required="true" name="nombreMadre[]" >
                  </div>

    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
         ...
         <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="<?php echo base_url(); ?>representantes/adicionarAlumnos">Adicionar Estudiantes</a>
        ...
        <li class="nav-item dropdown">
         ...
         <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="<?php echo base_url(); ?>alumnos/registro_alumnos">Registrar Representante/Alumnos</a>
        </div>
         ...
         <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="<?php echo base_url(); ?>cursos/crearCursos">Crear Cursos</a>
         <a class="dropdown-item" href="<?php echo base_url(); ?>cursos/listaCursos">Ver Cursos</a>
        </div>
         ...
         <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="<?php echo base_url(); ?>docentes/registro_docentes">Registro de Docentes</a>
         <a class="dropdown-item" href="<?php echo base_url(); ?>docentes/lista_docentes">Listar Docentes</a>
        </div>
        ...
        <li class="nav-item dropdown">
         ...
         <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="<?php echo base_url(); ?>cursos/inscripciones">Hacer Inscripción</a>
